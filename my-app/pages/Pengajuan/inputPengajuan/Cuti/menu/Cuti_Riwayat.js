      ...
      >
        ...
        >
          <View style={{ gap: 5 }}>
            ...
            <Text style={{ fontSize: 11, color: "#565E6CFF" }}>{Sisa}</Text>
          </View>
...
export default function Cuti_Riwayat() {
  return (
    <View style={{ paddingHorizontal: 20, gap: 10, marginTop: 30 }}>
      ...
      <CutiItem
        ...
        Sisa={"Sisa kuota cuti 3 dari 6 hari"}
      />
      <CutiItem
      ...
      <CutiItem
        ...
        Sisa={"Sisa kuota cuti 1 dari 6 hari"}
      />
