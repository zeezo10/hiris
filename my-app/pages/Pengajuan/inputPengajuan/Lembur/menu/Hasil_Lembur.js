...
const Hasil_Lembur_Item = ({
  ...
  return (
    ...
    >
      <View
        style={{
          backgroundColor: status === "Ditolak" ? "#FDF2F2FF" : "#F1F8FDFF",
          borderRadius: 6,
          height: 28,
          width: 160,
          overflow: "hidden",
        ...
        >
          <Text
            style={{
              flex: 1,
              fontSize: 11,
              color: status === "Ditolak" ? "#DE3B40FF" : "#379AE6FF",
              textAlign: "center",
            }}
          >
            Laporan Lembur {status}
          </Text>
        </View>
        {/* ------------------ */}
      ...
      >
        ...
        >
          ...
          <View style={{ flexDirection: "row", gap: 5, alignItems: "center" }}>
            ...
            <Text style={{ fontSize: 12, color: "#9095A0FF" }}>
              09:05 - 17:10 (Durasi: 03:26)
            </Text>
          </View>

          <View style={{ marginLeft: 20 }}>
            <Text style={{ fontSize: 12, color: "#9095A0FF" }}>
              09:05 - 23:00 (Lambat 3 jam 20 menit)
            </Text>
            <Text style={{ fontSize: 12, color: "#9095A0FF" }}>
              Upah Lembur: Rp 125.000
            </Text>
          </View>

          <View style={{ marginLeft: 20 }}>
            <Text
              style={{ color: "#565E6CFF", fontWeight: "400 ", fontSize: 12 }}
            >
              Tugas :{" "}
              <Text style={{ color: "#565E6CFF", fontSize: 12 }}>{tugas}</Text>
            </Text>
          </View>
        </View>
        ...
        >
          <View style={{}}>
            <Text style={{fontSize:12}}>Catatan yang Menyetujui:</Text>
            <Text
              style={{
                fontSize: 12,
            ...
            <Text style={{ fontWeight:"400" }}>{alasan}</Text>
            </Text>
          </View>
          ...
          <View style={{}}>
            ...
            <Text
              style={{ color: "#565E6CFF", fontWeight: "600", fontSize: 13 }}
            >
              Alasan laporan {status} :{" "}
            <Text style={{ fontWeight:"400" }}>{alasan}</Text>
            </Text>
          </View>

        </View> 
        <View style={{ paddingLeft:20, flexDirection:'row',  padding:10, gap:5}}>

        <AntDesign name="pdffile1" size={35} color="#E5696DFF" />
        <View>
        <Text style={{}}>Dokumen</Text>
        <Text style={{color:"#7A7A8DFF", fontSize:11}}>1,5 MB  Download</Text>
...
export default function Hasil_Lembur({ navigation }) {
